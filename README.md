...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;n_{l-1},n_{l}}" title="\Large n_{l-1},n_{l}" /> where <img src="https://latex.codecogs.com/svg.latex?\Large&space;n_{l-1}}" title="\Large n_{l-1}" /> and <img src="https://latex.codecogs.com/svg.latex?\Large&space;n_{l}}" title="\Large n_{l}" /> represent the size of the previous and current layer respectively. <img src="https://latex.codecogs.com/svg.latex?\Large&space;W_{l}}" title="\Large W_{l}" /> are also the target variables of our problem.  
