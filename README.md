...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;L(A_{2},Y)=-\frac{1}{m}(Ylog(A_{2})+(1-Y)log(1-A_{2}))" title="\Large L(A_{2},Y)=-\frac{1}{m}(Ylog(A_{2})+(1-Y)log(1-A_{2}))" /> 
